        ...
        <div class="col-md-6">
            <div class="card card-success">
                ...
                <!-- /.card-tools -->
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ url('/admin/gestiones/edit', $gestion->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label for="">Nombre</label>
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Escriba aqui..." name="nombre" value="{{ old('nombre', $gestion->nombre ?? '') }}" required>
                                                    </div>
                                                    @error('nombre')
