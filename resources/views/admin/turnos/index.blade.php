        ...
        <div class="col-md-6">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Turnos registradas</h3>
                <!-- /.card-tools -->
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="table-turnos" class="table table-bordered table-striped table-hover table-sm">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($turnos as $turno)
                                    <tr>
                                        <td style="text-align: center">{{ $contador_turnos++ }}</td>
                                        <td style="text-align: center">{{ $turno->nombre }}</td>
                                        <td style="text-align: center" class="text-center">
                                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                <a href="{{ url('admin/turnos/edit/'.$turno->id) }}" class="btn btn-success btn-sm"><i class="bi bi-pencil-fill"></i></a>
                                                ...
                                                <script>
                                                    function preguntar{{ $turno->id}}(event) {
                                                        ...
                                                        var form = document.getElementById('miFormulario{{ $turno->id }}');
                                                        Swal.fire({
                                                            title: '¿Estás seguro?',
