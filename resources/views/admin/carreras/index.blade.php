                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center" class="text-center">
                                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                <a href="{{ url('admin/carreras/edit/'.$carrera->id) }}" class="btn btn-success btn-sm"><i class="bi bi-pencil-fill"></i></a>
                                                <form action="{{ url('admin/carreras/delete/'.$carrera->id) }}" method="post" 
                                                ...
                                                <script>
                                                    function preguntar{{ $carrera->id}}(event) {
                                                        ...
                                                        var form = document.getElementById('miFormulario{{ $carrera->id }}');
                                                        Swal.fire({
                                                            title: '¿Estás seguro?',
