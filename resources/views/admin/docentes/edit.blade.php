                                    ...
                                    <div class="form-group">
                                        <label for="nombre">Nombre</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Escriba aqui..." name="nombre" value="{{ $docente->nombre }}" required>
                                            </div>
                                            @error('nombre')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="apellido">Apellido</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-fill"></i></span>
                                                <input type="text" class="form-control" placeholder="Escriba aqui..." name="apellidos" value="{{ $docente->apellidos }}" required>
                                            </div>
                                            @error('apellidos')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="dni">DNI</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control" placeholder="Escriba aquí su dni sin puntos" name="dni" value="{{ $docente->dni }}" required>
                                            </div>
                                            @error('dni')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="fecha_nacimiento">Fecha de nacimiento</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" class="form-control" name="fecha_nacimiento" value="{{ $docente->fecha_nacimiento }}" required>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label for="telefono">Teléfono</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="telefono" value="{{ $docente->telefono }}" required>
                                            </div>
                                            @error('telefono')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="email">Correo</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="email" value="{{ $docente->usuario->email }}" required>
                                            </div>
                                            @error('email')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                            ...
                                            <div class="text-center mt-2">
                                                <output style="padding= 10px" id="list">
                                                    @if (isset($docente->foto))
                                                        <img class="thumb thumbnail" src="{{ url($docente->foto) }}" width="50%" title= "{{ $docente->foto }}"/>
                                                    @endif
                                                </output>
                                            </div>    
                                    </div>
