...
@section('content_header')
    <h1>Personal estudiante/Editar datos del estudiante</h1>
@stop
                                    ...
                                    <div class="form-group">
                                        <label for="nombre">Nombre</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Escriba aqui..." name="nombre" value="{{ old('nombre', $estudiante->nombre) }}" required>
                                            </div>
                                            @error('nombre')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="apellido">Apellido</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-fill"></i></span>
                                                <input type="text" class="form-control" placeholder="Escriba aqui..." name="apellido" value="{{ old('apellido', $estudiante->apellido) }}" required>
                                            </div>
                                            @error('apellido')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="dni">DNI</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control" placeholder="Escriba aquí su dni sin puntos" name="dni" value="{{ old('dni', $estudiante->dni) }}" required>
                                            </div>
                                            @error('dni')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="fecha_nacimiento">Fecha de nacimiento</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" class="form-control" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $estudiante->fecha_nacimiento) }}" required>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label for="telefono">Teléfono</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="telefono" value="{{ old('telefono', $estudiante->telefono) }}" required>
                                            </div>
                                            @error('telefono')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="telefono">Referencia celular</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-telephone-fill"></i></span>
                                                <input type="text" class="form-control" name="ref_celular" value="{{ old('ref_celular', $estudiante->ref_celular) }}" required>
                                            </div>
                                            @error('ref_celular')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="apellido">Parentesco</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-fill"></i></span>
                                                <input type="text" class="form-control" placeholder="Escriba aqui..." name="parentesco" value="{{ old('parentesco', $estudiante->parentesco) }}" required>
                                            </div>
                                            @error('parentesco')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="email">Correo</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email" value="{{ old('email', $estudiante->usuario->email) }}" required>
                                            </div>
                                            @error('email')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="profesion">Profesión</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="profesion" value="{{ old('profesion', $estudiante->profesion) }}" required>
                                            </div>
                                            @error('profesion')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <label for="direccion">Dirección</label>
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="direccion" value="{{ old('direccion', $estudiante->direccion) }}" required>
                                                </div>
                                                @error('direccion')
                                                    <small style="color: red">{{ $message }}</small>    
                                                @enderror
